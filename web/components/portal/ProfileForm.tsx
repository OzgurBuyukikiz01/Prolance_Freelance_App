      ...
      <form action={updateProfile} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/30"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm resize-y focus:outline-none focus:ring-2 focus:ring-brand/30"
          />
        </div>
