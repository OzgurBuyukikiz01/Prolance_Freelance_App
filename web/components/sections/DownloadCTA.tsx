        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 mt-4">
            <a
              ...
              className="flex items-center gap-3 bg-brand hover:bg-brand/90 text-white px-6 py-4 rounded-2xl transition-colors shadow-lg min-w-[200px] justify-center"
            >
              ...
              <div className="flex flex-col leading-none text-left">
                <span className="text-[10px] text-white/80">Tarayıcıda aç</span>
                <span className="text-base font-semibold">Web Uygulaması</span>
              </div>
            </a>
