        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              showProlanceBottomSheet(
                context: context,
                title: appState.t('Sort by', 'Sırala'),
                child: SafeArea(
                  top: false,
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildSortOption(
                          appState.t('Newest', 'En yeni'),
                          JobSortOption.newest,
                        ),
                        _buildSortOption(
                          appState.t('Budget High-Low', 'Bütçe yüksek-düşük'),
                          JobSortOption.budgetHighLow,
                        ),
                        _buildSortOption(
                          appState.t('Budget Low-High', 'Bütçe düşük-yüksek'),
                          JobSortOption.budgetLowHigh,
                        ),
                        _buildSortOption(
                          appState.t('Most Proposals', 'En çok teklif'),
                          JobSortOption.mostProposals,
                        ),
                      ],
                    ),
                  ),
