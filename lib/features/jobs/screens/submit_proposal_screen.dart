    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (!normalized.isPositive) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Enter delivery time (years, months, or days).'),
            ...
            children: [
              ...
              Text(
                ApiConfig.isConfigured
                    ? 'Your proposal has been stored on the demo API.'
                    : 'Your proposal has been recorded locally for this demo.',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context);
                    app.triggerProposalSentCelebration();
                    app.addFeedNotification(
                      FeedNotificationItem(
                        id:
                            'prop_${DateTime.now().millisecondsSinceEpoch}',
                        title: app.t('Proposal sent', 'Teklif gönderildi'),
                        description: app.t(
                          'Your proposal for "${widget.job.title}" was submitted.',
                          '"${widget.job.title}" ilanına teklifiniz iletildi.',
                        ),
                        createdAt: DateTime.now(),
                        type: FeedNotificationType.proposal,
                      ),
                    );
                  },
